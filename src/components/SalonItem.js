               ...
               <span><button className="btn btn-danger ">
                   <StarRatings rating= {1.0} starDimension="30px"
                    ...
                    <div className="card col-lg-12">
                        <div style={{width: '100%'}}>
                        <img className="card-img-top" src="https://maps.googleapis.com/maps/api/staticmap?center=Brooklyn+Bridge,New+York,NY&zoom=13&size=600x300&maptype=roadmap&markers=color:blue%7Clabel:S%7C40.702147,-74.015794&key=AIzaSyBp8gPpJ1UADCI1B4jc9JWkC4378KYtdTc"/>
                        </div>
