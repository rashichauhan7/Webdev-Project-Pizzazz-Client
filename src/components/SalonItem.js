                    ...
                    <div className="col-4">
                        ...
                        <div className="card col-lg-10">
                            <div style={{width: '100%' ,padding: '0%'}}>
                                ...
                                '&zoom=13&size=600x300&maptype=roadmap&markers=color:blue%7Clabel:S%7C'+this.state.salon.coordinates.latitude+','+this.state.salon.coordinates.longitude+'&sensor=false'}/>
